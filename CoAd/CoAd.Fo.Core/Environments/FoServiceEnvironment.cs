...
using System.Xml;
using CoAd.Fo.Core.Contract;
using CoAd.Model;

namespace CoAd.Fo.Core.Environments
{
    public class FoServiceEnvironment : AbstractEnvironment
    {
        ...
        protected override Action StartAction
        {
            get
            {
                ...
                {
                    // endpoint
                    var uri = new Uri(String.Format("http://{0}/Service/", FoEngineModel.Instance.Configuration.CurrentConfig.Endpoint));
